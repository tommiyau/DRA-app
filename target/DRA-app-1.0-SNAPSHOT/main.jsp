    ...
    <body onload="startTime()">           
            ...
            <nav class="navbar navbar-inverse">
                <div class="container-fluid">
                    <div class="navbar-header">                        
                        ...
                        <a class="navbar-brand" >MongoDB Status</a>
                        <div class="container">
                            <div class="led-box">
        ...
        <div class="footer" >            
            ...
            <div class="bs-glyphicons" style="padding-bottom:10px;">          
                ...
                <a class="btn btn-warning glyphicon glyphicon-save" data-toggle="tooltip" title="MongoDB" href="https://www.mongodb.com/" target="_blank"></a>               
            </div>
        </div>  
