...
<html lang="en" >
    ...
    <body style="background:none transparent;">
        ...
        <div class="row">
            <form class="register-form" action="RegisterServlet" method="post" target="_parent">
                <p class="form_title">Register Details:  </p>&emsp;<span class="error"> <c:if test="${emptyErr!=null}"><c:out value="${emptyErr}"/></c:if></span>
                    <div class="form-group" id="fullname">
                        <input class="form-input" placeholder="Full name" name="name" required="true">                                       
                    </div>
                    ...
                    <div class="form-group" id="phone">
                        <input class="form-input" placeholder="Phone" name="phone" required="true">                                       
                    </div>
