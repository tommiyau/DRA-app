 ...
 * 
 */
public class MongoDBManager_2 extends MongoDB implements Serializable{

    private MongoCollection<Document> collection;

    //Run the MongoDB super-class constructor and build a connection with MongoDB Atlas
    public MongoDBManager_2(String owner, String password, String role, String db, String collection) {
